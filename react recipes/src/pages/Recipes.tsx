...
import { Box, Paper, Typography, List, ListItem, ListItemButton, ListItemText, CircularProgress, Button } from '@mui/material';
    ...
    return (
        <Box sx={{ p: 4 }}>
            <Box sx={{
                ...
                {isAuthenticated && (
                    <Button variant="contained" startIcon={<AddIcon />} onClick={() => navigate('/add-recipe')}                    >
                        Add Recipe
                    </Button>
                )}
            </Box>
